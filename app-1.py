...
def registrar_cita():
    ...
    fecha_cita = request.form['fecha']  # Obtener la fecha desde el formulario

    # Crear una instancia de la clase Database y guardar los datos
    db = Database()
    db.insert_data(placa, confirm_placa, serie, confirm_serie, modelo, correo_electronico, fecha_cita)
